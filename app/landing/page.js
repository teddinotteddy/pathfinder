  ...
  return (
    <div className="landing flex flex-col items-center min-h-screen p-4">
      <Card className="p-48 text-center">
        <CardHeader>
          <CardTitle className="text-5xl text-indigo-700 italic underline">Welcome to Pathfinder...</CardTitle>
        </CardHeader>
        <CardContent>
          <h1 className="text-2xl">Your Opportunities & Internships Hub</h1>
          <p className="text-xl text-muted-foreground max-w-screen-md">
